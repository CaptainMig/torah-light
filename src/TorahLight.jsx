...
const GLOBE_PINS = [
  ...
  { lat: 55.76, lng: 37.62, name: "Moscow", color: "#ef4444", linkTo: "heritage", story: "Your family's Russian roots. From the Pale to the Refuseniks to the 1990s exodus — resilience lives here." },
  { lat: 28.54, lng: 33.97, name: "Mount Sinai", color: "#f0d48a", linkTo: "torah", story: "Where God gave the Torah — the defining moment of Jewish identity." },
  { lat: 30.96, lng: 46.10, name: "Ur", color: "#f0d48a", linkTo: "torah", story: "Abraham's journey began here. Lech Lecha starts with leaving comfort behind." },
  { lat: 32.54, lng: 44.42, name: "Babylon", color: "#a78bfa", linkTo: "heritage", story: "Exile didn't end Jewish life — it transformed it. The Talmud was written here." },
  { lat: 46.48, lng: 30.73, name: "Odessa", color: "#ef4444", linkTo: "heritage", story: "The 'Jewish capital' of the Russian Empire — Hebrew literature, Zionism, and migration." },
  { lat: 54.69, lng: 25.28, name: "Vilnius", color: "#ef4444", linkTo: "heritage", story: "The Jerusalem of the North — the greatest center of Jewish scholarship in Europe." },
  { lat: 32.08, lng: 34.78, name: "Tel Aviv", color: "#22c55e", linkTo: "heritage", story: "Founded 1909 by Russian Jews. Over 1M Soviet Jews came in the 1990s, transforming the country." },
  { lat: 32.97, lng: 35.50, name: "Safed", color: "#a78bfa", linkTo: "values", story: "Birthplace of Kabbalah — Jewish mystical tradition. A city of seekers and artists." },
  { lat: 30.85, lng: 31.34, name: "Egypt", color: "#f0d48a", linkTo: "holidays", story: "The Exodus story begins here — slavery, freedom, courage, and the Passover memory." },
  { lat: 50.45, lng: 30.52, name: "Kyiv", color: "#ef4444", linkTo: "heritage", story: "One of the oldest Jewish communities in Eastern Europe. Babi Yar, 1941: 33,000+ murdered in two days." },
  { lat: 40.63, lng: -73.94, name: "Brooklyn", color: "#22c55e", linkTo: "heritage", story: "Largest Jewish community outside Israel. Brighton Beach = 'Little Odessa' — Russian Jewish culture lives on." },
  { lat: 31.53, lng: 35.10, name: "Hebron", color: "#f0d48a", linkTo: "torah", story: "Burial place of Abraham, Sarah, Isaac, Rebecca, Jacob, and Leah — the founders." },
  { lat: 31.31, lng: 35.35, name: "Masada", color: "#f0d48a", linkTo: "heritage", story: "Last stand against Rome. Symbol of Jewish resistance and the phrase 'Masada shall not fall again.'" },
  { lat: 32.83, lng: 35.59, name: "Sea of Galilee", color: "#f0d48a", linkTo: "torah", story: "Region of rabbinic teachings. The Mishnah was compiled nearby in Tiberias." },
];
          ...
          <button key={p.name} onClick={() => setSelPr(gi === selPr ? null : gi)} style={btn(gi === selPr)}>
            ...
            {gi === selPr && <div style={{ marginTop: 12, paddingTop: 12, borderTop: `1px solid ${C.gb}` }}>
              <div style={{ padding: "14px 16px", background: "rgba(212,168,83,0.08)", borderRadius: 10, marginBottom: 12 }}>
                ...
                <p style={{ color: C.parchment, fontSize: 13, margin: "0 0 8px", textAlign: "center", lineHeight: 1.6 }}>{p.english}</p>
                <button onClick={() => speak(p.transliteration)} style={{ display: "block", margin: "0 auto", background: "rgba(212,168,83,0.1)", border: `1px solid ${C.gb}`, borderRadius: 20, padding: "6px 16px", color: C.goldLight, cursor: "pointer", fontFamily: "Georgia,serif", fontSize: 12 }}>🔊 Hear it in Hebrew</button>
              </div>
